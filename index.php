...
<head>
    ...
    <title>Leitor Facial - Dashboard</title>
...
<body class="bg-light">
    <div class="container mt-5">
        <h2 class="text-center">📸 Leitor Facial - Dashboard</h2>
        <div class="row mt-4">
            <div class="col-md-6">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    echo "<div class='col-md-3 mb-3'>
                            <img src='" . $row['caminho'] . "' class='img-fluid rounded img-thumbnail' onclick='openPopup(\"" . $row['caminho'] . "\")'>
                          </div>";
                }
            } else {
                echo "<p class='text-muted'>Nenhuma imagem processada ainda.</p>";
            }
            ?>
        </div>
    </div>
